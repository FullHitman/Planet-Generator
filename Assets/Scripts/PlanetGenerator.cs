...
public class PlanetGenerator : MonoBehaviour
{
    ...
    public int GetMidPointIndex(Dictionary<int, int> cache, int indexA, int indexB)
    {
        ...
        // If a midpoint is already defined, retunr dat boi

        int ret;
        if (cache.TryGetValue(key, out ret))
            return ret;

        // Midpoint between two vertices needs to be added
    ...
    public TriangleHashSet Extrude(TriangleHashSet polys, float height)
    {
        ...
        // push each vertex away from planet center using height value
    ...
    public TriangleHashSet Inset(TriangleHashSet polys, float insetDistance)
    {
        ...
        // Push each vertex in towards the planet, then correct
    ...
    // The planets were way too boring when they were flat so added bumps to the surface
